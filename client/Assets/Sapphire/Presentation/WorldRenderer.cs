    ...
    public sealed class WorldRenderer : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            if(playing && app.Actors!=null)foreach(var a in app.Actors)
            {
                ...
                r.sprite=a.Boss?ui.ArtSprite("GuardianSprite","Goblin"):kind.Contains("spirit")?ui.ArtSprite("SpiritSprite","Goblin"):kind.Contains("wolf")?ui.ArtSprite("WolfSprite","Goblin"):ui.ArtSprite("GoblinSprite","Goblin");
            ...
            int index=0;if(playing && app.Projectiles!=null)foreach(var b in app.Projectiles){if(index==bullets.Count)bullets.Add(Make("Magic projectile",dot,600,Color.white));var r=bullets[index++];r.enabled=true;r.transform.position=new Vector3(b.X,b.Y+.15f,0);r.transform.rotation=Quaternion.Euler(0,0,Mathf.Atan2(b.DirectionY,b.DirectionX)*Mathf.Rad2Deg);Size(r,.28f,.13f);r.color=b.Hostile?new Color(1,.4f,.2f):new Color(.35f,.9f,1);}
