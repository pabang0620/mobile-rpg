...
namespace Sapphire.EditorTools
{
    ...
    internal static class VillageHubUiBuilder
    {
        internal static UiBuildResult Build(
            ...
            string regionName = "?¨Ìåå?¥Ïñ¥ Í¥ëÏû•")
        {
            BuildEventSystem();
        ...
        // reserves the SSOT's "ÏßÄ??Î≥¥Ïä§ HP" slot with the region name for now
        ...
        // coverage) despite every label in this file being Korean text ("Î©îÎâ¥",
        // "?•ÎπÑ", "??Í∏∞Îä•?Ä ?§Ïùå ?¨Îùº?¥Ïä§?êÏÑú ?∞Í≤∞?©Îãà??, ...) - a real,
        ...
        // "?úÍ??Ä ?ôÎ¥â NotoSansCJKkr ?∞Ìä∏") but nothing loaded it until now.
