...
namespace Sapphire.EditorTools
{
    ...
    internal static class CharacterFlowUiScaffold
    {
        ...
        /// <summary>A gold pill button (MenuButtonGold.png, 9-sliced) with a centered Korean-font label - the shape every "Í≤åÏûÑ ?úÏûë"/"?†ÌÉù"/"??†ú"/"?ùÏÑ±" button in this flow shares.</summary>
