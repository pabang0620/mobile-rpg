...
namespace Sapphire.EditorTools
{
    ...
    public static class SapphireSceneBuilder
    {
        ...
        public static void BuildAll()
        {
            ...
            {
                Debug.LogWarning("SapphireSceneBuilder.BuildAll()?Ä Î∞∞ÏπòÎ™®Îìú ?ÑÏö©?ÖÎãà?? ?Ä?îÌòï ?êÎîî?∞Ïóê???Ä???????¨ÏùÑ ?†Î¶¥ ???àÏñ¥ ?§Ìñâ??Í±¥ÎÑà?ÅÎãà??");
                return;
            }
        ...
        // and naming convention as Mage's (task spec: "?ôÏùº??Í≤©Ïûê/?Ä ?¨Í∏∞/
        // ?âÏó¥ ?úÏÑú"), just with "Warrior_" instead of "Mage_" as the sprite
